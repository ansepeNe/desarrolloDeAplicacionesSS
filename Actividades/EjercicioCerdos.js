...
export default function App (){
  ...
  return(
    ...
    >
      ...
      <Text style={{paddingTop:30,paddingBottom:30,paddingHorizontal:6,fontSize:21, color:'#212F3D',justifyContent:'center',textAlign:'center'}}>LOS 5 MEJORES CERDOS VIETNAMITAS</Text>
        <Switch 
